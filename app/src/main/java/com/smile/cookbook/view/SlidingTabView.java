...
public class SlidingTabView extends LinearLayout {
    ...
    public SlidingTabView(Context context, AttributeSet attrs) {
        ...
        mSelectedIndicatorPaint.setColor(Color.YELLOW);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (childCount > 0) {
            ...
            //0xFF6600为选中的颜色
            selectedTitle.setTextColor(blendColors(0xFFCC00,0xFF6600,mSelectionOffset));
            ...
            if (mSelectionOffset > 0f && mSelectedPosition < (getChildCount() - 1)) {
                ...
                nextTitle.setTextColor(blendColors(0xFF6600,0xFFCC00,mSelectionOffset));
            }
